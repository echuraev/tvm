...
class ArgInfo : public runtime::ObjectRef {
 public:
   ...
   */
  TVM_DLL static Array<ArgInfo, void> FromPrimFunc(const tir::PrimFunc& func, const Map<String, IntImm>& sym_var_hint = {});
  /*!
   ...
   * \return An array of the argument information derived.
   */
  TVM_DLL static Array<ArgInfo, void> FromEntryFunc(const IRModule& mod, bool remove_preproc, const Map<String, IntImm>& sym_var_hint = {});

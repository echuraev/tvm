...
class ModelImporter(object):
    ...
    def import_onnx_faster_rcnn(self, target="llvm", dtype="float32"):
        ...
        prefix = "/home/echuraev/Workspace/OctoML/tvm/"
        mod_file = prefix + f"onnx_faster_rcnn_mod_{dtype}.json"
        params_file = prefix + f"onnx_faster_rcnn_params_{dtype}.json"
        mod_file = prefix + f"onnx_faster_rcnn_mod.json"
        params_file = prefix + f"onnx_faster_rcnn_params.json"

...
def compute_depthwise_conv2d_NHWC_HWOI(Input, Filter, stride, padding, dilation, out_dtype=None, args={}):
    ...
    if len(Input.shape) == 4:
      ...
      if autotvm.GLOBAL_SCOPE.in_tuning == True:
        ...
        convert_from4d = True
        Input = pack_input(Input, "NHWC", batch, in_channel_chunks, in_channel_block, in_channel_tail, in_height, in_width)
...
def schedule_depthwise_conv2d_NHWC_HWOI(cfg, s, output, args={}):
    ...
    # TODO(amalyshe): verify if #of MACs are corect + verify in dw_nchw
